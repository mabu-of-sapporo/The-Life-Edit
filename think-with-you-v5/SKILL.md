...
metadata:
  ...
  size: "approx 4500 tokens (v4より約30%増・スタートアップ部分が増えた)"
...
your_action_after_reading:
  step_0: "★ NEW: read Part 0 (Jibun-Goto AI Tongue startup) and let the 4 axioms sit in your thinking-block"
